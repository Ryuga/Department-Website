# Generated by Django 4.2.6 on 2025-08-15 16:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.SlugField(
                        blank=True,
                        help_text="Leave empty to auto create or add custom",
                        max_length=30,
                        null=True,
                        unique=True,
                    ),
                ...
                (
                    "markdown_content",
                    models.TextField(
                        blank=True, help_text="Markdown content if any", null=True
                    ),
                ),
                (
                    "registration_link",
                    models.URLField(blank=True, help_text="Optional", null=True),
                ),
                (
                    "special_message",
                    models.TextField(
                        blank=True,
                        help_text="Special message to send in email if any",
                        null=True,
                    ),
                ),
                ("listing_order", models.IntegerField(default=0)),
                (
                    "custom_registration_button_link",
                    models.URLField(blank=True, help_text="Optional", null=True),
                ),
                (
                    "staff_in_charge",
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.CharField(
                        default=utils.functions.generate_registration_id,
                        max_length=9,
                        primary_key=True,
                        serialize=False,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Select if support option needs to be enabled",
                    ),
                ),
                (
                    "event_support_email",
                ...
                (
                    "youtube_video_box_title",
                    models.CharField(blank=True, max_length=30, null=True),
                ),
                (
                    "youtube_video_embed_code",
                    models.CharField(
                        blank=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "registered_programs",
                    models.ManyToManyField(blank=True, to="dashboard.program"),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.CharField(
                        default=utils.functions.generate_transaction_id,
                        max_length=9,
                        primary_key=True,
                        serialize=False,
                    ),
                ...
                (
                    "events_selected_json",
                    models.JSONField(
                        default=core.apps.dashboard.models.default_json, null=True
                    ),
                ),
                (
                    "bank_transaction_id",
                ...
                (
                    "creation_time",
                    models.DateTimeField(default=core.apps.dashboard.models.time_now),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="transaction_relation",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="dashboard.TransactionProgramRelation",
                to="dashboard.program",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="registration",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="dashboard.registration"
            ),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Will be displayed for default",
                        max_length=100,
                        null=True,
                    ),
                ),
